...
const box2Spawn: Array = [
	preload("res://Nodes/itemNodes/z_anvil.tscn"),
	preload("res://Nodes/itemNodes/z_Bomb.tscn"),
	preload("res://Nodes/itemNodes/z_Clothing.tscn"),
	preload("res://Nodes/itemNodes/z_Glassware.tscn"),
	preload("res://Nodes/itemNodes/z_Nails.tscn"),
	preload("res://Nodes/itemNodes/z_Tungstin.tscn"),
	preload("res://Nodes/itemNodes/z_Wire.tscn")
	]
...
func _input(_event: InputEvent) -> void:
	if Input.is_action_just_pressed("Reset") and not object:
		var newPlacement = box2Spawn.pick_random().instantiate()
		add_child(newPlacement)
		object = newPlacement
	elif Input.is_action_just_pressed("Reset") and isValid:
...
func _process(_delta: float) -> void:
	...
	if mouseGridPosition:
		...
		isValid = _check_and_hightlights_cells(objectCells)
...
func _check_and_hightlights_cells(objectCells: Array):
	var isValid = true
